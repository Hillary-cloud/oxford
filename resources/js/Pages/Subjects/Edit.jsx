            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Edit Subject</h2>
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Update the name or code for {subject.name}.</p>
                    </div>
                </div>
            }
        >
            ...
            <div className="max-w-2xl mx-auto">
                <Card title="Update Details" description="Modify the parameters for this subject.">
